...
- **Android:** [signed 0.2.10 preview APK](https://github.com/dion-labs/boxie/releases/tag/android-v0.2.10-preview.1). Android 8 or later. Connect personal Outlook to begin. Cloud sign-in and pairing are optional; existing vaults require approval from a trusted device before consolidation.
